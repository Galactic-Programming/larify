        ...
        <section className="bg-muted py-8 sm:py-16 lg:py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative mx-auto mb-12 w-fit sm:mb-16 lg:mb-24">
                    ...
                    <span className="absolute top-9 left-0 h-px w-full bg-primary"></span>
                </div>
                ...
                <div className="grid items-center gap-12 lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p className="mb-10 text-lg font-medium text-muted-foreground">
                            shadcn/studio gives you the blocks and components
                            you need to create a truly professional website,
                            landing page or admin panel for your SaaS and gives
                            the blocks.
                        </p>
