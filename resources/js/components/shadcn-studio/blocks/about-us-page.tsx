            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-12 space-y-4 text-center md:mb-16 lg:mb-24">
                    ...
                    <p className="text-xl text-muted-foreground">
                        ...
                        teamwork and perseverance. United, we have faced
                        challenges, celebrated victories, and woven a narrative
                ...
                <div className="relative mb-8 h-full w-full max-lg:space-y-6 sm:mb-16 lg:mb-24">
                    ...
                    <div className="grid gap-10 rounded-md border bg-background p-8 sm:max-lg:grid-cols-2 lg:absolute lg:-bottom-25 lg:left-1/2 lg:w-3/4 lg:-translate-x-1/2 lg:grid-cols-4 lg:px-10 xl:w-max">
