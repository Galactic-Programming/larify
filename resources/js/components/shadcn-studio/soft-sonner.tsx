 ...
 */
export const softToast = (variant: SoftToastVariant, message: string, options?: ExternalToast) => {
...
export const softToastInfo = (message: string, options?: ExternalToast) => softToast('info', message, options)

export const softToastSuccess = (message: string, options?: ExternalToast) => softToast('success', message, options)

export const softToastWarning = (message: string, options?: ExternalToast) => softToast('warning', message, options)

export const softToastError = (message: string, options?: ExternalToast) => softToast('error', message, options)
