            ...
            {canManageMembers ? (
                ...
                <div className="flex flex-col items-center justify-center rounded-lg border bg-card py-16">
                    ...
                    <p className="mb-6 max-w-sm text-center text-muted-foreground">
                        Start collaborating by adding team members to your
                        project. They'll be able to view or edit tasks based on
                        their role.
                    </p>
                    {onAddMember && (
                        <Button
                ...
                <div className="flex flex-col items-center justify-center rounded-lg border bg-linear-to-br from-amber-50/50 to-orange-50/50 py-16 dark:from-amber-950/20 dark:to-orange-950/20">
                    <div className="relative mb-6">
                    ...
                    <p className="mb-6 max-w-md text-center text-muted-foreground">
                        ...
                        Assign tasks, track progress together, and boost your
                        productivity.
                    </p>
